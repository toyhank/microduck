...
from .moon_gravity import make_moon_variant
...
register_mjlab_task(
    task_id="Mjlab-Velocity-Flat-Moon-MicroDuck",
    env_cfg=make_moon_variant(make_microduck_velocity_env_cfg()),
    play_env_cfg=make_moon_variant(make_microduck_velocity_env_cfg(play=True)),
    rl_cfg=MicroduckRlCfg,
    runner_cls=MicroduckOnPolicyRunner,
)
